...
class Options:
    def __init__(self, model_name: str):
        models = ["boundarynet", "unet", "cloudnet", "deeplabv3plus", "cdnetv2", "segnet", "hrnet", "mscff", "mfcnn", "swinunet", "mcdnet", "mynet", "fcn", "HRcloudNet", "MFFCDNet"]
        assert model_name in models
        parser = argparse.ArgumentParser('DJW -- Cloud Detection')
        # params of data storage
        parser.add_argument("--root", type=str, default="checkpoints_landsat8", help="absolute path of the dataset")
        ...
        parser.add_argument("--in_channels", type=int, default=4, help="number of image channels")
        parser.add_argument("--num_classes", type=int, default=1, help="number of classes")
        parser.add_argument("--file_suffix", type=str, default='.png', help="the filename suffix of train data")
        ...
        parser.add_argument("--dataset", type=str, default="landsat8", help="the name of the dataset")
